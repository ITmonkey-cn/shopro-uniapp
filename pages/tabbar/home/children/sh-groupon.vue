	...
	<view class="group-goods">
		<view class="title-box x-bc" @tap="jump('/pages/activity/groupon/list')">
			...
			<view class="group-people x-f">
				...
				<text class="tip">好友正在拼</text>
				<text class="cuIcon-right"></text>
			</view>
		</view>
		<view class="goods-box x-f">
			<shopro-activity-card :isTag="true" class="goods-item" v-for="item in 4" :key="item"><block slot="titleText">已拼111件</block></shopro-activity-card>
		</view>
	</view>
</template>
