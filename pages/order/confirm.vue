			...
			<view class="express-type">
				...
				<view class="express-type__content">
					...
					<view class="express-address" v-if="addressId && expressTypeCur !== 1" @tap="jump('/pages/user/address/list', { from: 'order' })">
						...
						<view class="detail" v-if="expressTypeCur !== 2">
					...
					<view class="oneself-address" v-if="addressId && expressTypeCur == 1">
						<view class="oneself-top">
							...
							<text class="cuIcon-right oneself-guide"></text>
						</view>
...
.express-type {
	...
	.express-type__content {
		...
		.oneself-address {
			...
			.oneself-top {
				position: relative;
				@include flex($justify: between, $align: top, $direction: null, $warp: null, $warpAlign: null);
				.address {
					width: 420rpx;
					font-size: 28rpx;
					font-family: PingFang SC;
