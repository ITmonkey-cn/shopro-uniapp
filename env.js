...
// #endif
const ENV_API_URL = {
	development: 'http://107-2.test.7wpp.com/addons/shopro/', //开发环境
	production: 'http://107-2.test.7wpp.com/addons/shopro/', //生产环境
}
const ENV_BASE_URL = {
	development: 'http://107-2.test.7wpp.com', //开发环境
	production: 'http://107-2.test.7wpp.com', //生产环境
}
